...
4. Seguir en vivo a los agentes construyendo, de forma divertida (**Mission Control** tipo RPG).
...
- Mission Control dinámico por modo (más/menos agentes, varios del mismo rol).
