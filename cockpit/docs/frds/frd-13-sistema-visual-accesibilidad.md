...
El cockpit debe sentirse **de ingeniería, no decorativo**, sin que Sergio (débil en diseño) tenga que afinar nada. La palanca es la **restricción tokenizada**: pocos colores, pocas variables de tema, motion sobrio. Derivado de la investigación 2026 (ver [docs/propuestas/06](../../../docs/propuestas/06-plan-de-mejoras-2026.md), referencias Linear/Vercel Geist/Rauno). Mantiene la paleta cálida tipo Anthropic ya aprobada en el prototipo.
...
- LA UI DEBERÁ honrar **`prefers-reduced-motion`**: deshabilita toda animación de Mission Control (sesiones largas → evitar fatiga).
...
## No-objetivos (v1)
- No es un design system publicable: es el sistema interno del cockpit. Reusa shadcn/Tailwind como vocabulario.
