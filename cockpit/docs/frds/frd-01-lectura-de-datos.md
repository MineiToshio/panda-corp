...
El cockpit lee de disco la información de la fábrica y de cada proyecto, sin escribir (salvo la excepción de descartar, FRD-02) y sin llamar a Claude.

## Criterios de aceptación (EARS)
- CUANDO el cockpit carga, EL sistema DEBERÁ leer todas las fichas de `panda-corp/fabrica/ideas/*.md` (ignorando `_plantilla-ficha.md`) con su frontmatter (título, estado, tipo, score).
