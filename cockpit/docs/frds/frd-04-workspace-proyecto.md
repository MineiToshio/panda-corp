...
- EL workspace DEBERÁ ofrecer pestañas, en este orden: **Resumen · Work orders · Mission Control · Documentos · Comandos** (Comandos al final, porque es contextual y repetitivo).
...
- LA pestaña **Mission Control** es la del [FRD-06](frd-06-mission-control.md); **Work orders** la del [FRD-05](frd-05-work-orders.md).
