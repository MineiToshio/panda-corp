...
- CADA subagente del workflow (investigador, backend, frontend, testing) DEBERÁ aparecer como un **sprite** (su avatar) ubicado en su zona.
- MIENTRAS no haya transición de etapa, los sprites DEBERÁN tener vida: una animación de "respiración" continua y **deambular** por toda su zona (no quedarse quietos).
- CUANDO el pipeline hace un **handoff** (transición de etapa), el sprite de la etapa entrante DEBERÁ moverse a la zona de la siguiente y **ambos DEBERÁN quedar juntos** (el que cede se hace a un lado), con una **burbuja de diálogo**.
