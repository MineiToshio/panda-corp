...
closes: "progress.md writer contract (milestones, not gate-tool exit lines) documented in factory/standards/build-orchestration.md §7 + plugin/skills/implement/SKILL.md + plugin/agents/reviewer.md; noise-canary + milestone-positive proof green; plugin v9.53.0"
links: []
---
