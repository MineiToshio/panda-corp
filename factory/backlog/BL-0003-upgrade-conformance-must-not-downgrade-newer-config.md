...
closed: 2026-07-03
source: "LESSON-0004"
closes: "DR-076 amendment (registry) + plugin/scripts/detect-gate-config-newer.sh + /upgrade step 3b (post-conformance project gate) + build-orchestration.md §5; plugin v9.53.0"
