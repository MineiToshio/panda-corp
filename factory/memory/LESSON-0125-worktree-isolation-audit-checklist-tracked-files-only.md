...
7. **Shared-checkout landing serialization** (LESSON-0158, personal-page-v2, 2026-07-12, corroborated
   2026-09-05) — editing is parallel (each worktree has its own tree) but LANDING is still serial: the
