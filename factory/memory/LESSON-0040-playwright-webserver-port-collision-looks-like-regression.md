...
BL-0049 (orphaned same-project lock) for the proposed build-engine preflight fixes. This exact failure
mode has now recurred EIGHT times across two projects (personal-page-v2 ×6, mission-control ×2) with no
code-side fix landed yet — a strong signal that BL-0049's preflight check is worth prioritizing.
