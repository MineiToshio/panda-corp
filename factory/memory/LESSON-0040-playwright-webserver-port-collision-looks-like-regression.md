...
lock) for the proposed build-engine preflight fixes. This exact failure mode has now recurred SIX times
across two projects (personal-page-v2 ×4, mission-control ×2) with no code-side fix landed yet — a strong
