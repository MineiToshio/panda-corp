...
| CONV-13 | Owner-facing claims: evidence before assertion — no fact asserted to the owner without an in-session tool observation; recorded state (flags, cached counts, subagent reports, prior audits) is re-verified, never repeated; the unverified is labeled unverified | MUST | conventions.md | agent self-check before asserting + owner spot-check (chat face of constitution §22/§24; build face wired via Stop gate + DR-068) | manual |
