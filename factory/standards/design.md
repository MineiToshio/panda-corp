...
| Engine injects design refs into the build prompt (DR-056 §2) | `plugin/runtime/engine/pandacorp-build.src.js` (`designRef`; deployed as the generated `plugin/templates/shared/.claude/engines/pandacorp-build.js`) |
