...
Scratchpads durables de `/pandacorp:explore`. **No son fichas** y **no aparecen en el tablero** (viven en este subdirectorio, fuera de `fabrica/ideas/*.md`, y no llevan `estado:`).
