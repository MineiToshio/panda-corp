...
**Impacto:** `fabrica/ideas/_plantilla-ficha.md`, `plugin/skills/new-idea/SKILL.md`. Reflejado en `mission-control/` (FRD-02) y DR-039.
...
**Impacto:** `plugin/skills/{discover,recommend,new-idea,onboarding}/SKILL.md`, `fabrica/perfil.example.md`, `fabrica/ideas/_plantilla-ficha.md`, `fabrica/constitucion.md` (misión), `fabrica/decisiones/registro.yaml` (DR-039), `mission-control/prototype/index.html`.
