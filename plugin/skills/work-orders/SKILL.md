...
5. **Actualiza** `docs/status.yaml` → `fase: implementacion` y commit. Resumen al dueño: cuántos work orders, orden, estimación gruesa. Siguiente paso: `/pandacorp:implement`.
