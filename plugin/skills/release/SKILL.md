...
5. **GATE HUMANO — PRODUCCIÓN (DR-004)**: presenta a Sergio el resumen (URL de staging para que pruebe, resultado de auditoría, costos al activar producción si los hay — DR-005). **Espera su aprobación explícita. Sin excepciones.**
