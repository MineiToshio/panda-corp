...
2. **Triage de impacto (el PM/architect decide el tamaño Y si hay que parar la construcción).** Lo que pide Sergio es de alto nivel; tu trabajo es decidir qué documentación cambiar/crear y avisarle en qué caso cae:
