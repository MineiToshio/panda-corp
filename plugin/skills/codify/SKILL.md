---
description: Codifica un estándar de ingeniería nuevo o una regla de decisión nueva en la fábrica Pandacorp. Usar cuando el dueño quiere agregar/ajustar una convención que se inyectará en los proyectos, o una decisión recurrente con default pre-aprobado. Se ejecuta EN la fábrica (panda-corp).
---
...
1. **Clasifica** lo que pide el dueño: ¿es un **estándar** (una regla de cómo se construye, que se inyecta en los proyectos) o una **regla de decisión** (un default pre-aprobado para que la IA no pregunte cada vez)? Si es ambiguo, pregunta.
