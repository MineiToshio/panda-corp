...
3. **Registra la respuesta** en `docs/decisiones.md`: `estado: resuelta`, la decisión textual del dueño, el racional si lo dio, y la fecha. Trazabilidad: una decisión resuelta nunca se borra, se marca resuelta.
