# Estado del proyecto {{PROJECT_NAME}} — leído por la fábrica Pandacorp y por el cockpit (en vivo)
...
work_orders_total: 0
work_orders_done: 0
decisiones_pendientes: 0   # nº de entradas pendientes en docs/decisiones.md (el cockpit las resalta)
