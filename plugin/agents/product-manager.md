...
7. **Decisión de pagos en v1 (DR-035):** el PRD declara explícitamente si la v1 **incluye pagos/cobro** (sí/no) — no se deja para después. Si **sí**, el estándar de pagos es **Polar** (Merchant of Record; ver `fabrica/estandares/servicios-externos.md`) y se AVISA (warning, no bloqueo) que en Vercel el cobro requiere plan Pro. Si **no**, la v1 puede vivir en Vercel Hobby mientras no monetice. Esta decisión condiciona el hosting en el blueprint.
