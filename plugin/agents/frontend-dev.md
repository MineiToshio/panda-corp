...
2. UI SOLO con los design tokens de `docs/design/design-tokens.json` y componentes shadcn/ui — cero colores/espaciados hardcodeados. Respeta los mockups aprobados en `docs/design/`.
