...
**Impacto:** `fabrica/estandares/servicios-externos.md` (nuevo), `fabrica/estandares/stack.md`, `fabrica/decisiones/registro.yaml` (DR-035..038), `plugin/agents/{product-manager,devops}.md`, `plugin/skills/{spec,blueprint,release}/SKILL.md`, `plugin/.claude-plugin/plugin.json` (1.1.0 → 1.2.0).
