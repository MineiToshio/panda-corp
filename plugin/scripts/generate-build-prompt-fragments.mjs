...
const next = body.replace(/^const SYNC_ROLLUPS = .*$/m, generated).replace(/^const WHOLE_FRD_ORACLE = .*$/m, generatedWholeFrd).replace(/^const DRIFT_CLAIM_DIRECTIVE = .*$/m, generatedDriftClaim);
