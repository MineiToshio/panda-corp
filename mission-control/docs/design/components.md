...
| `WoDag` | **Stub placeholder** until WO-12-006 — binary-tree icon + count text; the real Dagre implementation (bezier-edge DAG, chain-highlight, jump-to-first-error, follow-active-step) is delivered by WO-12-006 (FRD-12) | `src/app/projects/[slug]/_observability/WoDag/WoDag.tsx` | `workOrders: WorkOrder[]`, `project?: string` | **real stub** (WO-12-005; full impl → WO-12-006, prototype `bDag`/`bDagChain` ~L1169) |
