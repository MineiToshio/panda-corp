...
- WHEN a project has `docs/status.yaml`, the system SHALL read phase, version, running, progress, work order count, `pending_decisions`, `pending_bugs`, `last_green_sha` and `safe_to_test`.
