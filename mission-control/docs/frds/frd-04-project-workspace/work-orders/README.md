...
| [WO-04-008](./wo-04-008-change-card-relative-date.md) | Changes tab: relative date on the change card (`formatChangeDate`) | lib (TDD) + UI | PLANNED | CMP-04-change-card | WO-04-004 |
