...
| WO-17-004 | Proposals surface: stream/card + promotions queue + memory health + badge/chip | `app/`, `components/` | PLANNED (gate REJECTED 2026-06-21, reopen_count 1: DR-057/062 reuse — MemoryHealth/PromotionsQueue/ProposalsBadge fork bespoke header/banner/panel/chip/count-pill instead of the shared primitives) | WO-17-002, WO-17-003, FRD-13 |
